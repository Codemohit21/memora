...
export const UpdateUserData = async (req, res) => {
  try {
    ...
    let { username, bio, location, full_name } = bodyData;
    ...
    if (tempUser.username !== username) {
      ...
      if (user && user._id.toString() !== tempUser._id.toString()) {
    ...
    // to upload image we are going to use imagekit
    if (profile) {
    ...
    if (cover) {
      ...
      console.log("before updated data in update");
...
console.log("GET USER CONNECTION")
    console.log(user)
