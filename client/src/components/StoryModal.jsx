  ...
  return (
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div
          className="rounded-lg h-96 flex bg-blue-500 items-center justify-center relative"
        ...
        <div className="flex gap-2 mt-4">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2rounded cursor-pointer ${
              mode === "text" ? "bg-white text-black" : "bg-zinc-700"
            }`}
          >
